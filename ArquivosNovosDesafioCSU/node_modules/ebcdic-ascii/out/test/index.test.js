...
var ebcdicTestStringFR_FR = "818283848586878889919293949596979899A2A3A4A5A6A7A8A9C1C2C3C4C5C6C7C8C9D1D2D3D4D5D6D7D8D9E2E3E4E5E6E7E8E9F0F1F2F3F4F5F6F7F8F9C0D0527C43CB7174726463EB";
...
describe("ebcdic-ascii", function () {
    describe("toASCII", function () {
        ...
        it("should resolve a french ebcdic string", function () {
            var converter = new __1.default("0297");
            var ascii = converter.toASCII(ebcdicTestStringFR_FR);
    ...
    describe("toEBCDIC", function () {
        ...
        it("should convert french ASCII to EBCDIC and back", function () {
            var converter = new __1.default("0297");
            var expectedString = "éèêàäôÉÈÊÀÄÔ Test String !@#¤%&/()[]{}^'*_-:.;,";
            var ebcdic = converter.toEBCDIC(Buffer.from(expectedString, "ascii").toString("hex"));
            var ascii = converter.toASCII(ebcdic);
            expect(ascii).toEqual(expectedString);
        });
    ...
    describe("toISO", function () {
        ...
        it("should convert french EBCDIC to ISO and back", function () {
            var converter = new __1.default("0297");
            var isoHex = converter.toISO(ebcdicTestStringFR_FR);
            var ebcdic = converter.toEBCDIC(isoHex.toString("hex"));
